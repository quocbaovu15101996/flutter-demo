class ListGrobot {
  ...
  ListGrobot.fromJson(Map<String, dynamic> json) {
    data = json["data"] == null
        ? null
        : (json["data"] as List).map((e) => GrobotItem.fromJson(e)).toList();
    total = json["total"];
  }
...
class GrobotItem {
  ...
  GrobotItem({this.id, this.owner, this.createdAt, this.price, this.grobot});

  GrobotItem.fromJson(Map<String, dynamic> json) {
    id = json["id"];
    owner = json["owner"];
    createdAt = json["createdAt"];
    price = json["price"];
    grobot = json["grobot"] == null ? null : GrobotInfo.fromJson(json["grobot"]);
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data["price"] = price;
    if (grobot != null) data["grobot"] = grobot?.toJson();
    return data;
  }
}
...
class GrobotInfo {
  ...
  GrobotInfo.fromJson(Map<String, dynamic> json) {
    id = json["id"];
  ...
  Map<String, dynamic> toJson() {
    ...
    data["status"] = status;
    data["ggenre"] = ggenre;
    if (gmodel != null) data["gmodel"] = gmodel?.toJson();
